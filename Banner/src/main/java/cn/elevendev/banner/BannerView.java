...
import cn.elevendev.banner.Adapter.BannerAdapter;
import cn.elevendev.banner.Config.BannerConfig;
import cn.elevendev.banner.Config.IndicatorConfig;
import cn.elevendev.banner.Indicator.Indicator;
import cn.elevendev.banner.Listener.OnBannerListener;
import cn.elevendev.banner.Listener.OnPageChangeListener;
import cn.elevendev.banner.Transformer.MZScaleInTransformer;
import cn.elevendev.banner.Transformer.ScaleInTransformer;
import cn.elevendev.banner.Utils.BannerLifecycleObserver;
import cn.elevendev.banner.Utils.BannerLifecycleObserverAdapter;
import cn.elevendev.banner.Utils.BannerUtils;
import cn.elevendev.banner.Utils.ScrollSpeedManger;


public class BannerView<T, BA extends BannerAdapter<T, ? extends RecyclerView.ViewHolder>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    static class AutoLoopTask implements Runnable {
        ...
        AutoLoopTask(BannerView banner) {
            this.reference = new WeakReference<>(banner);
        }

        @Override
        public void run() {
            BannerView banner = reference.get();
     ...
     * @return
     */
    public BannerView setIntercept(boolean intercept) {
     ...
     * @return
     */
    public BannerView setCurrentItem(int position) {
     ...
     */
    public BannerView setStartPosition(int mStartPosition) {
     ...
     */
    public BannerView setUserInputEnabled(boolean enabled) {
     ...
     */
    public BannerView addPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
     ...
     */
    public BannerView setPageTransformer(@Nullable ViewPager2.PageTransformer transformer) {
        getViewPager2().setPageTransformer(transformer);
        return this;
    }

    public BannerView removeTransformer(ViewPager2.PageTransformer transformer) {
     ...
     * 添加 ItemDecoration
     */
    public BannerView addItemDecoration(RecyclerView.ItemDecoration decor) {
        getViewPager2().addItemDecoration(decor);
        return this;
    }

    public BannerView addItemDecoration(RecyclerView.ItemDecoration decor, int index) {
     ...
     */
    public BannerView setLoopTime(long loopTime) {
     ...
     * 设置banner的适配器
     */
    public BannerView setAdapter(BA adapter) {
        if (adapter == null) {
     ...
     * @return
     */
    public BannerView setAdapter(BA adapter,boolean isInfiniteLoop) {
     ...
     */
    public BannerView setDatas(List<T> datas) {
        if (getAdapter() != null) {
     ...
     */
    public BannerView setOrientation(@Orientation int orientation) {
     ...
     * 改变最小滑动距离
     */
    public BannerView setTouchSlop(int mTouchSlop) {
     ...
     * 设置点击事件
     */
    public BannerView setOnBannerListener(OnBannerListener<T> listener) {
        if (getAdapter() != null) {
     ...
     * @param radius 圆角半径
     */
    public BannerView setBannerRound(float radius) {
    ...
    public BannerView setBannerRound2(float radius) {
     ...
     */
    public BannerView setBannerGalleryEffect(int itemWidth, int pageMargin) {
     ...
     * @param pageMargin     页面间距,单位dp
     */
    public BannerView setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin) {
     ...
     */
    public BannerView setBannerGalleryEffect(int itemWidth, int pageMargin, float scale) {
     ...
     * @param scale          缩放[0-1],1代表不缩放
     */
    public BannerView setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin, float scale) {
        if (pageMargin > 0) {
     ...
     * @param itemWidth item左右展示的宽度,单位dp
     */
    public BannerView setBannerGalleryMZ(int itemWidth) {
     ...
     * @param scale     缩放[0-1],1代表不缩放
     */
    public BannerView setBannerGalleryMZ(int itemWidth, float scale) {
        if (scale < 1 && scale > 0) {
     ...
     */
    public BannerView setIndicator(Indicator indicator, boolean attachToBanner) {
        removeIndicator();
    ...
    public BannerView setIndicatorSelectedColor(@ColorInt int color) {
    ...
    public BannerView setIndicatorSelectedColorRes(@ColorRes int color) {
        setIndicatorSelectedColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public BannerView setIndicatorNormalColor(@ColorInt int color) {
        if (getIndicatorConfig() != null) {
    ...
    public BannerView setIndicatorNormalColorRes(@ColorRes int color) {
        setIndicatorNormalColor(ContextCompat.getColor(getContext(), color));
        return this;
    }

    public BannerView setIndicatorGravity(@IndicatorConfig.Direction int gravity) {
    ...
    public BannerView setIndicatorSpace(int indicatorSpace) {
        if (getIndicatorConfig() != null) {
    ...
    public BannerView setIndicatorMargins(IndicatorConfig.Margins margins) {
        if (getIndicatorConfig() != null && getIndicatorConfig().isAttachToBanner()) {
    ...
    public BannerView setIndicatorWidth(int normalWidth, int selectedWidth) {
        if (getIndicatorConfig() != null) {
    ...
    public BannerView setIndicatorNormalWidth(int normalWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setNormalWidth(normalWidth);
        }
        return this;
    ...
    public BannerView setIndicatorSelectedWidth(int selectedWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setSelectedWidth(selectedWidth);
        }
        return this;
    ...
    public BannerView setIndicatorRadius(int indicatorRadius) {
        if (getIndicatorConfig() != null) {
    ...
    public BannerView setIndicatorHeight(int indicatorHeight) {
        if (getIndicatorConfig() != null) {
    ...
    public BannerView addBannerLifecycleObserver(LifecycleOwner owner) {
        if (owner != null) {
