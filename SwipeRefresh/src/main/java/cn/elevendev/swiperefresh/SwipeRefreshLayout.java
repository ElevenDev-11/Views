...
import cn.elevendev.swiperefresh.annotation.Action;
import cn.elevendev.swiperefresh.annotation.Mode;
import cn.elevendev.swiperefresh.annotation.Orientation;
import cn.elevendev.swiperefresh.config.Constants;
import cn.elevendev.swiperefresh.extra.IRefreshView;
import cn.elevendev.swiperefresh.indicator.DefaultIndicator;
import cn.elevendev.swiperefresh.indicator.IIndicator;
import cn.elevendev.swiperefresh.indicator.IIndicatorSetter;
import cn.elevendev.swiperefresh.manager.VRefreshLayoutManager;
import cn.elevendev.swiperefresh.manager.VScaleLayoutManager;
import cn.elevendev.swiperefresh.utils.AppBarLayoutUtil;
import cn.elevendev.swiperefresh.utils.ScrollCompat;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingChild3 {
    ...
    public interface OnPerformAutoLoadMoreCallBack {
         ...
         */
        boolean canAutoLoadMore(SwipeRefreshLayout parent, @Nullable View child);
    }
    ...
    public interface OnPerformAutoRefreshCallBack {
         ...
         * @return whether need trigger
         */
        boolean canAutoRefresh(SwipeRefreshLayout parent, @Nullable View child);
    }
    ...
    public abstract static class LayoutManager {
        ...
        protected final String TAG = getClass().getSimpleName() + "-" + SwipeRefreshLayout.sId++;
        ...
        protected byte getRefreshStatus() {
            return mLayout == null ? SwipeRefreshLayout.SR_STATUS_INIT : mLayout.mStatus;
        }
    ...
    class ScrollChecker implements Runnable {
        ...
        public void run() {
            ...
            if (!finished) {
                ...
                ViewCompat.postOnAnimation(SwipeRefreshLayout.this, this);
